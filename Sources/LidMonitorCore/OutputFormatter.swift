...
struct OutputFormatter: Sendable {
    ...
    func autoSleepTransitionLine(_ event: AutoSleepTransitionEvent) -> String {
        ...
        case .startupClosedCandidateStarted: value = "startup-closed-candidate"
        case .startupClosedCandidateCancelled: value = "startup-closed-cancelled"
        case .startupClosedDebounceElapsed: value = "startup-closed-debounce-elapsed"

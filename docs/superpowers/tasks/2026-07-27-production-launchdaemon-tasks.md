...
| 13 | Enabled bounded acceptance — recovery resleep complete | validation evidence | dry-run path, first enabled sleep, and bounded recovery-resleep complete; injected failure remains | recovery resleep completed; injected failure remains non-sleeping | automatic disable/bootout/bootstrap cleanup |

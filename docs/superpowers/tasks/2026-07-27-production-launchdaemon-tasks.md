...
| 12 | Production dry-run acceptance — logged-in and loginwindow complete; sleep/wake command ready | validation evidence | logged-in and loginwindow complete; controlled sleep/wake command verified and awaiting real execution | sleep approved; separate reboot approval remains | automatic disable/bootout/bootstrap cleanup |

...
| 12 | Production dry-run acceptance — logged-in scope complete; loginwindow commands ready | validation evidence | logged-in complete; two-phase loginwindow evidence pending real execution; sleep/wake pending | logout approved; separate sleep/reboot approvals remain | automatic disable/bootout/bootstrap cleanup |

...
export MANAGED_REBOOT_OBSERVER="$MANAGED_SUPPORT/reboot-observer.sh"
export MANAGED_REBOOT_OBSERVER_EVIDENCE="$MANAGED_SUPPORT/reboot-observer-evidence.plist"
export MANAGED_REBOOT_OBSERVER_PLIST="$SYSTEM_ROOT/Library/LaunchDaemons/com.crazydennies.macbook-lid-monitor.reboot-observer.plist"
export REBOOT_OBSERVER_LABEL="com.crazydennies.macbook-lid-monitor.reboot-observer"
export SOURCE_REBOOT_OBSERVER="$REPO_ROOT/scripts/lib/production-reboot-observer.sh"
export SOURCE_REBOOT_OBSERVER_PLIST="$REPO_ROOT/packaging/launchd/com.crazydennies.macbook-lid-monitor.reboot-observer.plist"
